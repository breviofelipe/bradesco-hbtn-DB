...
public class MongoDBConnection {
    ...
    private static final String USERNAME = "ENV_USER";
    private static final String PASSWORD = "ENV_PASS";
    private static final String CLUSTER_URL = "mongodb.net"; // Substitua pelo seu cluster se for diferente
    private static final String DATABASE_NAME = "TESTE"; // Substitua pelo nome do seu banco de dados
